...
#ifndef NETFOX_IOS_SWIFT_H
#define NETFOX_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="netfox_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10netfox_ios3NFX")
...
@interface NFX (SWIFT_EXTENSION(netfox_ios)) <UIAdaptivePresentationControllerDelegate>
...
SWIFT_CLASS("_TtC10netfox_ios12NFXHTTPModel")
...
SWIFT_CLASS("_TtC10netfox_ios11NFXProtocol")
...
@interface NFXProtocol (SWIFT_EXTENSION(netfox_ios)) <NSURLSessionDataDelegate>
...
@interface UIWindow (SWIFT_EXTENSION(netfox_ios))
